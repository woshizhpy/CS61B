...
/*     if (head == null) {
  ...
  public static void main (String[] args) {
	...
	lst3.insertFront(new Integer(12));
	lst3.insertFront(new Integer(9));
	lst3.insertFront(new Integer(6));
	System.out.println("Here is a list after construction: "+ lst3.toString());
	lst3.insertFront(new Integer(3));
	lst3.insertEnd(new Integer(15));
	System.out.println("Here is a list after construction: "+ lst3.toString());
	testEmpty();
