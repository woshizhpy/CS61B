...
public class SList {
   ...
   **/
  public void deleteNextNode(SListNode cnode) {
   ...
   **/
  public void InsertAfter(SListNode cnode, Object obj) {
	  
	  SListNode addNode=new SListNode(obj,cnode.next);
	  cnode.next=addNode;
  }

  public void twin() {
    // Fill in your solution here.  (Ours is seven lines long.)
	SListNode cnode=head;
	if(!isEmpty()) {
		while(cnode!=null)
		{
			InsertAfter(cnode,cnode.item);
